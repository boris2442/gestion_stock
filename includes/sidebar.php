 <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-blue-800 to-violet-700 text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
    ...
    <nav class="mt-5">
      <a href="view_produit.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
        <i data-feather="package" class="w-5 h-5 mr-3"></i> Liste Produits
      </a>
      <a href="../formulaires/form_produit.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
        <i data-feather="plus-circle" class="w-5 h-5 mr-3"></i> Ajouter Produit
      </a>
      <a href="view_client.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
        <i data-feather="users" class="w-5 h-5 mr-3"></i> Liste Clients
      </a>
      <a href="../formulaires/form_client.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
        <i data-feather="user-plus" class="w-5 h-5 mr-3"></i> Ajouter Client
      </a>
      <a href="view_fournisseur.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
        <i data-feather="truck" class="w-5 h-5 mr-3"></i> Liste Fournisseurs
      </a>
      <a href="../formulaires/form_fournisseur.php" class="flex items-center px-4 py-2 hover:bg-blue-700">
