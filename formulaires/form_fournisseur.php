...
require_once "../configuration/config_fournisseur.php";
require_once '../includes/header.php';
?>

<section class="min-h-screen w-full flex items-center justify-center bg-blue-100 p-4">
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-2xl ml-64">
        <h2 class="text-2xl font-bold text-blue-800 mb-6 text-center">Ajouter un fournisseur</h2>
